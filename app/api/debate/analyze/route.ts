    ...
    try {
      ...
      return NextResponse.json({
        ...
        result: {
          ...
          team1Score: 75,
          team2Score: 75,
          team1Strengths: '논리적 근거를 체계적으로 제시하고 구체적인 사례를 효과적으로 활용했습니다.',
          team2Strengths: '창의적인 관점을 제시하고 감정적 어필을 통해 설득력을 높였습니다.',
          team1Weaknesses: '일부 주장이 추상적이어서 구체성에 아쉬움이 있었습니다.',
          team2Weaknesses: '논리적 근거가 부족한 부분이 있어 설득력에 한계가 있었습니다.',
